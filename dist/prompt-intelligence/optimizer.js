...
export class PromptOptimizer {
    ...
    passCollapseInstructions(sections) {
        return sections.map(s => {
    ...
    passCompressSummaries(sections) {
        return sections.map(s => {
    ...
    passPrioritizeSymbols(sections, targetSymbol) {
        if (!targetSymbol)
            return sections;
        return sections.map(s => {
    ...
    passRemoveDeadSections(sections) {
