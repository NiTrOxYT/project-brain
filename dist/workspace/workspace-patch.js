...
export class WorkspacePatchEngine {
     ...
     */
    generatePatch(filePath, oldContent, newContent, provider) {
    ...
    applyPatch(patch) {
        ...
        for (const hunk of patch.hunks) {
            if (hunk.startLine < pos) {
                throw new WorkspacePatchError(patch.path, `Overlapping hunk at line ${hunk.startLine} (current position: ${pos})`);
            }
