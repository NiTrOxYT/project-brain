...
`;
    ...
    generateOperatingProcedureSection(tools) {
        const getToolLink = (base) => {
...
`;
    ...
    generateRepositoryPolicySection() {
...
`;
    ...
    async generateMCPToolsSection(tools) {
    ...
    generateDecisionTreeSection(tools) {
        const getToolLink = (base) => {
            const found = tools.find(t => t.name === `brain.${base}`);
            return found ? `\`${found.name}\`` : "N/A";
        };
...
`;
    ...
    generateWorkflowExamplesSection(tools) {
        const getToolLink = (base) => {
            const found = tools.find(t => t.name === `brain.${base}`);
            return found ? `\`${found.name}\`` : "N/A";
        };
...
`;
    ...
    generateEfficiencySection(tools) {
        const getToolLink = (base) => {
            const found = tools.find(t => t.name === `brain.${base}`);
            return found ? `\`${found.name}\`` : "N/A";
        };
