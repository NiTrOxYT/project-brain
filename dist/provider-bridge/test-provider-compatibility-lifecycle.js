...
async function runTests() {
    ...
    const driftCheck1 = ProviderLockRegistry.checkDrift("test-gateway", "/usr/bin/test-gateway", "1.5.0", testConfigPath, workspaceRoot);
    ...
    const driftCheck2 = ProviderLockRegistry.checkDrift("test-gateway", "/usr/bin/test-gateway", "1.5.0", testConfigPath, workspaceRoot);
