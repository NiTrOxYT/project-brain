...
export class GraphCompiler {
    ...
    compile(context, dependencies) {
        ...
        if (rawGraph) {
            const rawNodes = Array.isArray(rawGraph)
                ? rawGraph
        ...
        const archEntries = context.architectureData?.entries || [];
        ...
        const topologicalOrder = this.normalizer.topologicalSort(normalizedNodes, normalizedEdges);
        return {
