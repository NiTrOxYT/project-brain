...
export class SnapshotCollector {
    ...
    async collect() {
        const [indexData, symbolsData, importsData, relationshipsData, graphData, architectureData, evolutionData, learningData, semanticMemoryData, filePaths] = await Promise.all([
