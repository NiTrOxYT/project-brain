...
export function resolveOllamaPath() {
...
export class OllamaProvider extends BaseSDKProvider {
    ...
    async health() {
        ...
        let version = "1.0.0";
        const details = { executablePath: exe, host: "localhost:11434" };
        ...
        const status = installed && details.serverReachable ? "Healthy" : (installed ? "Degraded" : "Offline");
        return {
            status,
            authenticated,
            installed,
