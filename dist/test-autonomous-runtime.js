...
function makeNode(id, phaseId = "PHASE-1", type = "create", prerequisites = []) {
    return {
        id,
        title: `Task ${id}`,
...
class TestAgentRuntime extends AgentRuntimeService {
    executeCount = 0;
    repairCount = 0;
    simulateTransientCount = 0;
    simulateTransientFailures = 0;
    simulateTimeoutCount = 0;
    simulateTimeoutFailures = 0;
    sessions = new Map();
...
function setupMockValidatorScript(workspaceRoot) {
...
// ─── Tests ────────────────────────────────────────────────────────────────────
async function test01_PlanExecutionAndPhaseOrdering() {
...
async function test02_ValidationAndRepairLoop() {
...
async function test03_RetryLoopOnTransientError() {
...
async function test04_ExecutionTimeoutAndRetry() {
...
async function test05_CheckpointingAndInterruptedRecovery() {
...
async function test06_JournalReplayAndMetrics() {
...
async function test07_ParallelSafeExecution() {
