...
export class RuntimeExecutor {
    ...
    cancelCalls = 0;
    eventsCount = 0;
    constructor(engine, middlewares = [], hooks = [], timings = { middleware: {}, hook: {}, eventCounts: {} }) {
        this.engine = engine;
        this.middlewares = middlewares;
        this.hooks = hooks;
        this.timings = timings;
    }
    async runMiddleware(hookName, request, ...args) {
    ...
    compileMetrics(provider, capability, timeMs, artifactsCount) {
        return {
            provider,
            capability,
