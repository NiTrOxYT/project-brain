...
export class CapabilityNegotiator {
     ...
     */
    negotiate(candidates, ctx, healthReports) {
        if (candidates.length === 0) {
            throw new ProviderNegotiationError(ctx.capability, "No providers registered for this capability");
        }
        ...
        if (usable.length === 0) {
            throw new ProviderNegotiationError(ctx.capability, "All registered providers are offline or unavailable");
        }
    ...
    computeCapabilityScore(provider, ctx) {
