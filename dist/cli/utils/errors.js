...
export class CliError extends Error {
    exitCode;
    constructor(message, exitCode = EXIT_INTERNAL) {
        super(message);
...
export class UserInputError extends CliError {
    constructor(message) { super(message, EXIT_USER_INPUT); }
}
export class ValidationError extends CliError {
    constructor(message) { super(message, EXIT_VALIDATION); }
}
export class WorkspaceError extends CliError {
    constructor(message) { super(message, EXIT_WORKSPACE); }
}
export class RuntimeError extends CliError {
    constructor(message) { super(message, EXIT_RUNTIME); }
}
