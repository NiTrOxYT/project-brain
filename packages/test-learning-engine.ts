...
function createMockResult(planId: string, status: "Completed" | "Failed", journal: JournalEvent[]): ExecutionLoopResult {
    return {
        planId,
        status,
        summary: {
...
async function test02_PatternClassification() {
    ...
    const exp1 = {
        ...
        taskType: "refactor", taskTitle: "Refactor types", outcome: "success" as const,
...
async function test03_ProviderStatistics() {
    ...
    const exps = [
        ...
        },
        {
            ...
            taskType: "refactor", taskTitle: "Refactor types", outcome: "failure" as const,
    ...
    const rules = [
        {
            ...
            ruleType: "provider-preference" as const,
    ...
    const mockExp = [
        {
            ...
            taskType: "document", taskTitle: "Write README", outcome: "success" as const,
...
async function test14_QueryEngineDiagnostics() {
    ...
    await fs.writeFile(
        path.join(cacheDir, `${queryHash}.json`),
