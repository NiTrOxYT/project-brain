...
import { LaunchWrapperDescriptor, LaunchWrapperIntegration } from "./provider-bridge/integration.js";
import type { RuntimeEnvironment, IntegrationDescriptor, ProviderIntegration, SupportResult } from "./provider-bridge/integration.js";
...
async function runTests() {
    ...
    const dummySession: GatewaySession = {
        id:              "gs-test-session",
        providerId:      "opencode",
        projectRoot:     "/tmp",
        workspaceRoot:   "/tmp",
    ...
    await test("3. Negotiation selection selects highest priority supported integration", async () => {
        ...
        class MockSdkDescriptor implements IntegrationDescriptor {
        ...
        const envWithoutSdk: RuntimeEnvironment = {
        ...
        const envWithSdk: RuntimeEnvironment = {
            operatingSystem: "macos",
