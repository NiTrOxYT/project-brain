...
export class ConflictResolver {
    ...
    resolve(conflict: ConflictRecord, resolvedByAgentId?: string): ConflictResolution {
        ...
        const agents = conflict.involvedAgents.map(id => state.agents.get(id)).filter(Boolean) as any[];
