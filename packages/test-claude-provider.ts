...
function makeTask(id: string, type: string = "create"): RuntimeTask {
    return {
        id,
        type: type as any,
        title: `Test task ${id}`,
...
function writeMockBinary(tempDir: string, behavior: string): string {
...
async function test01_ExecutableAndVersion(): Promise<void> {
...
async function test02_AuthenticationDetection(): Promise<void> {
...
async function test03_PromptBuilder(): Promise<void> {
...
async function test04_ExecutionAndResponseParsing(): Promise<void> {
...
async function test05_StreamingEvents(): Promise<void> {
...
async function test06_WorkspaceEngineCompatibility(): Promise<void> {
...
async function test07_RetryOnTransientFailure(): Promise<void> {
...
async function test08_PermanentFailureNoRetry(): Promise<void> {
...
async function test09_ExecutionTimeout(): Promise<void> {
...
async function test10_Cancellation(): Promise<void> {
...
async function test11_SessionSupport(): Promise<void> {
    console.log("\n── 11. Session Support ───────────────────────────────────────");
    const tempDir = makeTempDir();
    try {
...
async function test12_Diagnostics(): Promise<void> {
...
async function test13_ResponseParserRobustness(): Promise<void> {
...
async function test14_RegressionMockSDKProvider(): Promise<void> {
