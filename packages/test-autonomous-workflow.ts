...
import { WorkflowDiagnostics } from "./autonomous-workflow/types";
import { WorkflowPlanner } from "./autonomous-workflow/planner";
import { WorkflowScheduler } from "./autonomous-workflow/scheduler";
import { WorkflowExecutor } from "./autonomous-workflow/executor";
import { WorkflowValidator } from "./autonomous-workflow/validator";
import { WorkflowRepair } from "./autonomous-workflow/repair";
import { WorkflowJournalService } from "./autonomous-workflow/journal";
import { WorkflowCheckpointService } from "./autonomous-workflow/checkpoint";
import { WorkflowMetricsTracker } from "./autonomous-workflow/metrics";
import { WorkflowReportGenerator } from "./autonomous-workflow/report";
...
async function runTests() {
    ...
    try {
        ...
        const mockPlan = {
            ...
            intent: "feature",
            confidence: 95,
            complexity: { score: 1, label: "Small" as any },
            risk: { api: 1, execution: 1, history: 1, architecture: 1, ownership: 1, overall: "Low" as any },
            phases: [
            ...
            diagnostics: { planningTimeMs: 1, graphNodes: 2, graphEdges: 1, dependencyDepth: 1, affectedModules: 1, complexity: "Small" as any, riskScore: 1 }
        };
