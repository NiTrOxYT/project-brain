...
export class SnapshotDeltaEngine {
    compute(from: SemanticSnapshot, to: SemanticSnapshot): SnapshotDelta {
        ...
        const fullRecompileRequired =
            from.metadata.fingerprint.filesystemHash !==
