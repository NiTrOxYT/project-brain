...
export class WrapperDispatcher {
    ...
    constructor(providerId: string, args: string[], paths?: GlobalPaths) {
    ...
    private async executePassthrough(realBinary: string, debugMode: boolean): Promise<void> {
    ...
    private async executeGateway(realBinary: string, debugMode: boolean): Promise<void> {
