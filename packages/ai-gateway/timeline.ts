...
import type { TimelineEntry, GatewayEvent, GatewayEventKind } from "./types.js";
...
export class TimelineStore {
     ...
     */
    record(event: GatewayEvent, label: string, detail?: string): void {
        ...
        if (event.payload["durationMs"] != null) {
            entry.durationMs = event.payload["durationMs"] as number;
        }
     ...
     */
    complete(kind: GatewayEventKind, durationMs: number): void {
