...
export interface DirtyRegionResult {
    ...
    dirtyGraphNodes: string[];
    dirtyArchitecture: string[];
    dirtyLearning: string[];
}

export class DirtyRegionTracker {
    compute(prev: SemanticSnapshot, resolvedDirtyFiles: string[]): DirtyRegionResult {
        ...
        const dirtyRelationships: string[] = [];
